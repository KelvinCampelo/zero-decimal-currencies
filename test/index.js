...
import zeroDecimalCurrencies, { display } from "../src/lib/";
...
test("Test display with no zero decimal currency", t => {
  var zeroDecimal = zeroDecimalCurrencies(14.1000000052, "EUR");
  var disp = display(zeroDecimal, "EUR");
  t.is(disp, "14.10");
  t.pass();
});

test("Test display with zero decimal currency", t => {
  var zeroDecimal = zeroDecimalCurrencies(100.5100000052, "JPY");
  var disp = display(zeroDecimal, "JPY");
  t.is(disp, "101");
  t.pass();
});
